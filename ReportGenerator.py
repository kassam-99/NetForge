...
class Report_Generator:
    ...
    def _add_metadata(self, file):
        ...
        file.write(f"Generated by: {getpass.getuser()}\n")
    ...
    def _metadata_dict(self):
        """Returns report metadata as a JSON-serializable dictionary."""
        return {
    ...
    def JSON_GenerateReport(self, Data, filename=None):
        ...
        try:
            ...
            with open(filename, 'w') as jsonfile:
                # Keep the whole file valid JSON: metadata + records in one object.
                json.dump({"metadata": self._metadata_dict(), "records": Data},
                          jsonfile, indent=4)
