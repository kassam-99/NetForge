...
class Logs:
    ...
    def LogEngine(self, folder_name="logs", log_name="application"):
        ...
        # getLogger returns the same cached logger for a given name, so only
        # attach a FileHandler once to avoid duplicated log lines when the
        # inheritance chain re-instantiates Logs for the same log_name.
